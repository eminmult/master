...
const REVIEWS = [
  { name: "Jennifer K.", date: "2 weeks ago", rating: 5, text: "Marcus completely rewired our 1920s brownstone. Immaculate work, transparent pricing, and he explained every decision. The kind of craftsperson you keep for life.", avatar: "assets/reviewer-1.jpg", verified: true },
  { name: "David T.", date: "1 month ago", rating: 5, text: "Emergency panel replacement on a Sunday. Marcus was there in 40 minutes and had power restored within three hours. Professional, clean, communicative.", avatar: "assets/contact-1.jpg", verified: true },
  { name: "Priya S.", date: "2 months ago", rating: 4, text: "Solid work on a whole-home smart-lighting install. A small scheduling hiccup early on, but the result is exactly what we wanted. Would book again.", avatar: "assets/contact-2.jpg", verified: true },
];
