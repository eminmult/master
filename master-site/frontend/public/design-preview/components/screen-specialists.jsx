...
const SPECIALISTS = [
  { id: 1, name: "Marcus Vane",    title: "Principal Systems Architect", rating: 4.98, reviews: 842, price: 180, avatar: "assets/marcus.jpg", tags: ["Strategy", "Blockchain"], available: "Today", response: "Quick" },
  { id: 2, name: "Alex Rivera",    title: "HVAC Specialist",            rating: 4.87, reviews: 312, price: 95, avatar: "assets/alex-rivera.jpg", tags: ["HVAC", "Climate"], available: "Today", response: "< 15 min" },
  { id: 3, name: "Sarah Chen",     title: "Senior Electrician",          rating: 4.92, reviews: 521, price: 110, avatar: "assets/sarah-chen.jpg", tags: ["Wiring", "Panels"], available: "Tomorrow", response: "Quick" },
  { id: 4, name: "Ethan Park",     title: "Master Plumber",              rating: 4.75, reviews: 287, price: 85, avatar: "assets/contact-1.jpg", tags: ["Leaks", "Fixtures"], available: "Today", response: "~ 30 min" },
  { id: 5, name: "Sophia Lane",    title: "Cleaning Lead",               rating: 5.00, reviews: 198, price: 60, avatar: "assets/contact-2.jpg", tags: ["Deep Clean", "Move-out"], available: "Today", response: "Quick" },
  { id: 6, name: "Noah Hartwell",  title: "Journeyman Electrician",      rating: 4.65, reviews: 154, price: 70, avatar: "assets/contact-3.jpg", tags: ["Lighting", "Outlets"], available: "Weekend", response: "~ 1 hr" },
];
