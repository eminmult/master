    ...
    <div ref={ref} style={{ position: "relative" }}>
      <button
        ...
        style={{
          ...
          padding: "8px 12px",
          background: open ? "rgba(255,255,0,0.08)" : "transparent",
          border: `1px solid ${open ? "rgba(255,255,0,0.25)" : "var(--border-2)"}`,
          borderRadius: 10,
          color: "var(--text)",
      ...
      {open && (
        <div style={{
          ...
          padding: 6,
          zIndex: 1000,
          animation: "langFade 160ms ease-out",
        }}>
          <div style={{
            padding: "8px 12px 10px",
            fontSize: 10, fontWeight: 700,
            color: "var(--text-3)", letterSpacing: "1.2px",
            ...
            return (
              ...
              >
                ...
                <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: 1 }}>
                  <span style={{ fontSize: 13, fontWeight: 600 }}>{l.native}</span>
...
if (typeof document !== "undefined" && !document.getElementById("lang-styles")) {
  const s = document.createElement("style");
  s.id = "lang-styles";
  s.textContent = "@keyframes langFade { from { opacity: 0; transform: translateY(-4px); } to { opacity: 1; transform: none; } }";
  ...
  <header className="topbar">
    ...
    <div className="nav-right">
      ...
      <div className="profile-chip">
        ...
        <div className="avatar" style={{ backgroundImage: `url(${user?.avatar || "assets/julianne.jpg"})` }} />
      </div>
    </div>
  </header>
);
...
Object.assign(window, { Logo, TopBarPublic, TopBarLogged, StarRow, FooterBar, LangPicker });
